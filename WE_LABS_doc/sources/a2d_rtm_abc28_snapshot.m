function [img,illum]=a2d_rtm_abc28_snapshot(seis,v,nbc,dx,nt,dt,s,sx,sz,gx,gz)
...
for it=1:nt
    ...
    if mod(it,100)==1
        figure(3);subplot(233);colormap(gray);imagesc(x,z,p(nbc+1:nbc+nz,nbc+1:nbc+nx));
